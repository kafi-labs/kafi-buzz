...
use super::{
    ...
    default_agent_command, effective_agent_command, managed_agent_avatar_url, normalize_agent_args,
    probe_codex_acp_version, record_agent_command, remove_record_effort_aliases,
...
// Intelligence Platform runtime catalog tests live in
// discovery/tests/intel_runtime.rs.
mod intel_runtime;
