...
pub(crate) const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    ...
    KnownAcpRuntime {
        ...
        adapter_install_instructions_url: "https://github.com/block/buzz",
        cli_install_hint:
            "Build via `cargo build -p buzz-intel-agent` (ships with Buzz agent tooling).",
        adapter_install_hint: "",
        skill_dir: None,
        supports_acp_model_switching: false,
        // The model field selects a deployed Intelligence Platform agent.
        model_env_var: Some("INTEL_AGENT"),
        // The provider field is the fixed Intelligence Platform gateway URL.
        ...
        // The first element is the executable, followed by its auth probe flag.
